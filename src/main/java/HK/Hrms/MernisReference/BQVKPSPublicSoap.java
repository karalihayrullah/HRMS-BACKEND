...
public class BQVKPSPublicSoap
{
    ...
    public BQVKPSPublicSoap(){}

    public BQVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BQVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BQVExtendedSoapSerializationEnvelope envelope= new BQVExtendedSoapSerializationEnvelope(BQVExtendedSoapSerializationEnvelope.VER11);

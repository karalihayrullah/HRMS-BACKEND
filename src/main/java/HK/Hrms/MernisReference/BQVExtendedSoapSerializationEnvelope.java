...
public class BQVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BQVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BQVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BQVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BQVDateTimeConverter dateTimeConverter = new BQVStandardDateTimeConverter();

    public BQVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BQVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BQVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BQVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BQVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BQVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
